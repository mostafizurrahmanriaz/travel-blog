...
.hero-section {
    ...
    background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.5)), 
                url({{ $first_blog->featured_image }}) center/cover no-repeat;
    display: flex;
...
<div class="hero-content text-center">
    <h1 class="hero-title">WanderSphere Travel Blog</h1>
    <p class="hero-subtitle">Better to see something once than hear about it a thousand times!</p>
    <div class="hero-buttons">
        <button class="btn-explore">Explore</button>
        <button class="btn-journies">Journies</button>
    </div>
</div>
@endsection
...
<section class="info-section">
    <div class="container">
        <div class="info-box">
            <h2 class="info-title">We travel the world, and tell you how it looks!</h2>
            <p class="info-text">
                Traveling beyond maps to capture stories, cultures, and unforgettable journeys.
                We explore destinations around the world and share real experiences, practical guides, and inspiring stories to help you travel smarter and deeper.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                @if((int)request('page') === 1 || (int)request('page') == null)
                <article class="blog-card">
                    ...
                    <div class="blog-card-body">
                        ...
                        <div class="blog-card-meta">
                            {{-- @foreach ($first_blog->category as $category)  --}}
